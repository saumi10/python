...
class Employee:
    ...
    def get_salary(self): # self is important here because self is a way to reference the object of the class which is being created. It is mandatory to give first parameter as self    
        return 34000
